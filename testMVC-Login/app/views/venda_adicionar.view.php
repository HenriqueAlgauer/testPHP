        ...
        <div class="shadow rounded py-5">
            <form id="vendaForm" class="px-5 d-flex justify-content-between" method="post">
                ...
                <div class="d-flex flex-column justify-content-between align-items-center">
                    ...
                    <div class="d-flex flex-column justify-content-between align-items-center" id="produtos-selecionados">
                ...
                <div class="w-25 d-flex flex-column justify-content-between">
                    <div class="d-flex align-items-center gap-2 mb-5">
                        ...
                        <select style='max-width:120px' class="form-select" name="formaPagamento" id="formaPagamento" aria-label="Default select example">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex pe-5 justify-content-between">
                                            <input style="max-width: 120px;" class="form-control" type="number" name="quantidade" placeholder="Qnt." min="1">
                                            <button type="button" class="btn btn-primary" onclick="addProduct(<?php echo $produto->id; ?>, '<?php echo $produto->nome; ?>', <?php echo $produto->preco; ?>, this.previousElementSibling.value)">Adicionar</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
