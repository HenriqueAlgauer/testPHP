    ...
    <main class="mx-auto w-50 shadow rounded">
        ...
        <div class="d-flex justify-content-center">
            <form class="w-50 d-flex flex-column align-items-center" method="POST">
                <span class="text-center">Deseja realmente <strong>EXCLUIR</strong> esse Registro?</span>
                ...
                <button class="btn btn-primary" type="submit">Confirmar opção</button>
            </form>
        </div>

    </main>
    <a class="mx-auto my-5" href="<?=ROOT?>/venda">Voltar pagina</a>
